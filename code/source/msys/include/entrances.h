...
namespace msys {
  ...
  const EntrancesByScene Entrances_Ranch = {.title = "Romani Ranch Buildings",
                                            .nbItems = 2,
  ...
  const EntrancesByScene Entrances_Southern_Swamp_Clear = {.title = "Southern Swamp Clear",
                                                           .nbItems = 11,
  ...
  const EntrancesByScene Entrances_Curiosity_Shop = {.title = "Curiosity Shop",
                                                     .nbItems = 4,
  ...
  const EntrancesByScene Entrances_Cutscene_Scene = {.title = "Cutscene Scene",
                                                     .nbItems = 10,
  ...
  const EntrancesByScene Entrances_Stone_Tower_Temple_Inverted = {
      ...
      .nbItems = 3,
      .items = {{0x2A00, "from Stone Tower"}, {0x2A10, "after opening boss door"}, {0x2A20, "(crash)"}}};

  const EntrancesByScene Entrances_Clock_Tower_Rooftop = {
      .title = "Clock Tower Rooftop",
      .nbItems = 3,
      .items = {{0x2C00, "from South Clock Town"}, {0x2C10, "after learning Song of Time"}, {0x2C20, "(crash)"}}};

  const EntrancesByScene Entrances_Deku_Intro_Scene = {.title = "Deku Intro Scene",
                                                       .nbItems = 5,
  ...
  const EntrancesByScene Entrances_Ancient_Castle_Of_Ikana = {.title = "Ancient Castle Of Ikana",
                                                              .nbItems = 7,
  ...
  const EntrancesByScene Entrances_Town_Shooting_Gallery = {
      ...
      .nbItems = 2,
      .items = {{0x3A00, "from East Clock Town (with title card)"}, {0x3A10, "from East Clock Town (no title card)"}}};
  ...
  const EntrancesByScene Entrances_Milk_Road = {.title = "Milk Road",
                                                .nbItems = 7,
  ...
  const EntrancesByScene Entrances_Pirates_Fortress_Sewers = {
      ...
      .nbItems = 16,
      .items = {{0x4000, "hookshot room (chest floor)"},
  ...
  const EntrancesByScene Entrances_Fairys_Fountain = {.title = "Fairy's Fountain",
                                                      .nbItems = 10,
  ...
  const EntrancesByScene Entrances_Deku_Palace = {.title = "Deku Palace",
                                                  .nbItems = 11,
  ...
  const EntrancesByScene Entrances_Termina_Field = {.title = "Termina Field",
                                                    .nbItems = 15,
  ...
  const EntrancesByScene Entrances_Goron_Shrine = {.title = "Goron Shrine",
                                                   .nbItems = 4,
  ...
  const EntrancesByScene Entrances_Zora_Hall_Atrium = {.title = "Zora Hall Atrium",
                                                       .nbItems = 9,
  ...
  const EntrancesByScene Entrances_Trading_Post = {
      .title = "Trading Post",
      .nbItems = 2,
      .items = {{0x6200, "from West Clock Town (with title card)"}, {0x6210, "from West Clock Town (no title card)"}}};

  const EntrancesByScene Entrances_Romani_Ranch = {.title = "Romani Ranch",
                                                   .nbItems = 12,
  ...
  const EntrancesByScene Entrances_Deku_Kings_Chamber = {.title = "Deku King's Chamber",
                                                         .nbItems = 4,
  ...
  const EntrancesByScene Entrances_Road_To_Southern_Swamp = {.title = "Road To Southern Swamp",
                                                             .nbItems = 3,
  ...
  const EntrancesByScene Entrances_Doggy_Racetrack = {
      .title = "Doggy Racetrack", .nbItems = 2, .items = {{0x7C00, "from Romani Ranch"}, {0x7C10, "after dog race"}}};

  const EntrancesByScene Entrances_Cucco_Shack = {
      .title = "Cucco Shack", .nbItems = 2, .items = {{0x7E00, "from Romani Ranch"}, {0x7E10, "getting Bunny Hood"}}};

  const EntrancesByScene Entrances_Ikana_Graveyard = {.title = "Ikana Graveyard",
                                                      .nbItems = 6,
  ...
  const EntrancesByScene Entrances_Woodfall = {.title = "Woodfall",
                                               .nbItems = 5,
  ...
  const EntrancesByScene Entrances_Zora_Trial = {
      .title = "Zora Trial", .nbItems = 2, .items = {{0x8800, "from The Moon"}, {0x8810, "from taking a wrong turn"}}};

  const EntrancesByScene Entrances_Goron_Village_Spring = {.title = "Goron Village Spring",
                                                           .nbItems = 5,
  ...
  const EntrancesByScene Entrances_Great_Bay_Temple = {
      ...
      .nbItems = 3,
      .items = {{0x8C00, "from Zora Cape"}, {0x8C10, "from Pirates Cutscene Scene"}, {0x8C20, "(crash)"}}};
  ...
  const EntrancesByScene Entrances_Goron_Village_Winter = {.title = "Goron Village Winter",
                                                           .nbItems = 5,
  ...
  const EntrancesByScene Entrances_Ghost_Hut = {
      .title = "Ghost Hut",
      .nbItems = 3,
      .items = {{0x9C00, "from Ikana Canyon"}, {0x9C10, "from poe killing game"}, {0x9C20, "after beating the poes"}}};

  const EntrancesByScene Entrances_Deku_Shrine = {.title = "Deku Shrine",
                                                  .nbItems = 3,
  ...
  const EntrancesByScene Entrances_Igos_Du_Ikanas_Lair = {
      .title = "Igos Du Ikana's Lair", .nbItems = 1, .items = {{0xA600, "from Ancient Castle of Ikana"}}};

  const EntrancesByScene Entrances_Tourist_Information = {.title = "Tourist Information",
                                                          .nbItems = 3,
                                                          .items = {{0xA800, "from Southern Swamp"},
                                                                    {0xA810, "after boat cruise"},
                                                                    {0xA820, "after turning in pictograph"}}};

  const EntrancesByScene Entrances_Stone_Tower_Upright = {.title = "Stone Tower Upright",
                                                          .nbItems = 4,
  ...
  const EntrancesByScene Entrances_Path_To_Goron_Village_Winter = {
      ...
      .nbItems = 3,
      .items = {{0xB400, "from Mountain Village"}, {0xB410, "from Goron Village"}, {0xB420, "from Goron Racetrack"}}};

  const EntrancesByScene Entrances_Path_To_Goron_Village_Spring = {
      .title = "Path To Goron Village Spring",
      .nbItems = 3,
      .items = {{0xB600, "from Mountain Village"}, {0xB610, "from Goron Village"}, {0xB620, "from Goron Racetrack"}}};
  ...
  const EntrancesByScene Entrances_Stock_Pot_Inn = {.title = "Stock Pot Inn",
                                                    .nbItems = 6,
  ...
  const EntrancesByScene Entrances_Clock_Tower_Inside = {.title = "Clock Tower Inside",
                                                         .nbItems = 7,
  ...
  const EntrancesByScene Entrances_Lost_Woods = {
      .title = "Lost Woods",
      .nbItems = 3,
      .items = {{0xC400, "after Skull Kid steals Epona"}, {0xC410, "after first SoT (cutscene)"}, {0xC420, "(crash)"}}};

  const EntrancesByScene Entrances_Link_Trial = {.title = "Link Trial", .nbItems = 1, .items = {{0xC600, "from moon"}}};
  ...
  const EntrancesByScene Entrances_Bomb_Shop = {
      .title = "Bomb Shop",
      .nbItems = 2,
      .items = {{0xCA00, "from West Clock Town (with title card)"}, {0xCA10, "from West Clock Town (no title card)"}}};

  const EntrancesByScene Entrances_Giants_Chamber = {
      .title = "Giants' Chamber", .nbItems = 1, .items = {{0xCC00, "from boss lair"}}};

  const EntrancesByScene Entrances_Gorman_Track = {.title = "Gorman Track",
                                                   .nbItems = 6,
  ...
  const EntrancesByScene Entrances_Goron_Racetrack = {
      ...
      .nbItems = 3,
      .items = {{0xD000, "from Path to Goron Village"}, {0xD010, "starting Goron race"}, {0xD020, "after Goron race"}}};

  const EntrancesByScene Entrances_East_Clock_Town = {.title = "East Clock Town",
                                                      .nbItems = 13,
  ...
  const EntrancesByScene Entrances_West_Clock_Town = {.title = "West Clock Town",
                                                      .nbItems = 10,
  ...
  const EntrancesByScene Entrances_North_Clock_Town = {.title = "North Clock Town",
                                                       .nbItems = 8,
  ...
  const EntrancesByScene Entrances_South_Clock_Town = {.title = "South Clock Town",
                                                       .nbItems = 11,
  ...
  const EntrancesByScene Entrances_Laundry_Pool = {
      .title = "Laundry Pool",
      .nbItems = 3,
      .items = {{0xDA00, "from South Clock Town"}, {0xDA10, "from Curiosity Shop"}, {0xDA20, "(crash)"}}};
