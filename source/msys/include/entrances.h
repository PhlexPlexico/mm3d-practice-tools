...
const EntrancesByScene Entrances_Southern_Swamp_Clear = {
    ...
    .nbItems = 11,
    .items = {
        {0x0C00, "from Road to Southern Swamp"},
...
const EntrancesByScene Entrances_Cutscene_Scene = {
    ...
    .nbItems = 10,
    .items = {
        {0x1C00, "Intro Story (black screen with white text)"},
...
const EntrancesByScene Entrances_Ikana_Canyon = {
    ...
    .nbItems = 16,
    .items = {
        {0x2000, "central room from Road to Ikana"},
...
const EntrancesByScene Entrances_Pirates_Fortress_Tower = {
    ...
    .nbItems = 15,
    .items = {
        {0x2200, "from target platform over moat (intro)"},
...
const EntrancesByScene Entrances_Deku_Intro_Scene = {
    ...
    .nbItems = 5,
    .items = {
        {0x2E00, "from Lost Woods (cutscene)"},
...
const EntrancesByScene Entrances_Woodfall_Temple = {
    ...
    .nbItems = 3,
    .items = {
        {0x3000, "front room from Woodfall"},
...
const EntrancesByScene Entrances_Ancient_Castle_Of_Ikana = {
    ...
    .nbItems = 7,
    .items = {
        {0x3400, "courtyard from Beneath the Well"},
...
const EntrancesByScene Entrances_Deku_Palace = {
    ...
    .nbItems = 11,
    .items = {
        {0x5000, "from Southern Swamp (front doorway)"},
...
const EntrancesByScene Entrances_Goron_Shrine = {
    ...
    .nbItems = 4,
    .items = {
        {0x5E00, "from Goron Village (intro)"},
...
const EntrancesByScene Entrances_Zora_Hall_Atrium = {
    ...
    .nbItems = 9,
    .items = {
        {0x6000, "from Zora Cape underwater mouth"},
...
const EntrancesByScene Entrances_Twinmolds_Lair = {
    ...
    .nbItems = 5,
    .items = {
        {0x6600, "from Stone Tower Temple"},
...
const EntrancesByScene Entrances_Deku_Kings_Chamber = {
    ...
    .nbItems = 4,
    .items = {
        {0x7600, "king's quarters from Deku Palace"},
...
const EntrancesByScene Entrances_Goron_Village_Spring = {
    ...
    .nbItems = 5,
    .items = {
        {0x8A00, "from Path to Goron Village"},
...
const EntrancesByScene Entrances_Goron_Village_Winter = {
    ...
    .nbItems = 5,
    .items = {
        {0x9400, "from Path to Goron Village"},
...
const EntrancesByScene Entrances_Mountain_Village_Winter = {
    ...
    .nbItems = 9,
    .items = {
        {0x9A00, "after beating Snowhead Temple"},
...
const EntrancesByScene Entrances_Deku_Shrine = {
    ...
    .nbItems = 3,
    .items = {
        {0x9E00, "from Deku Palace (with title card)"},
...
const EntrancesByScene Entrances_Mountain_Village_Spring = {
    ...
    .nbItems = 9,
    .items = {
        {0xAE00, "after beating Snowhead Temple"},
...
const EntrancesByScene Entrances_Stock_Pot_Inn = {
    ...
    .nbItems = 6,
    .items = {
        {0xBC00, "from East Clock Town (front door)"},
...
const EntrancesByScene Entrances_Lost_Woods = {
    ...
    .nbItems = 3,
    .items = {
        {0xC400, "after Skull Kid steals Epona"},
...
const EntrancesByScene Entrances_Goron_Racetrack = {
    ...
    .nbItems = 3,
    .items = {
        {0xD000, "from Path to Goron Village"},
...
const EntrancesByScene Entrances_South_Clock_Town = {
    ...
    .nbItems = 11,
    .items = {
        {0xD800, "from Clock Tower (inside)"},
