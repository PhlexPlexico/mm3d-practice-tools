...
static void Command_Levitate(void){
    ...
    if (link) {
        link->lin_vel_xxx = 6.34375f;
        link->lin_vel_xxx2 = 6.34375f;
        link->lin_vel_max = 6.34375f;
    } 
}
...
static void Command_ReloadScene(void){
    // TODO: Figure out how scenes work.
...
static Command commandList[] = {
    ...
    {"Reload Scene (TODO)", 0, 0, { 0 }, Command_ReloadScene, COMMAND_PRESS_ONCE_TYPE, 0, 0},
