...
#define ITEM_COUNT_FULL 0x63
  ...
  ToggleMenu CheatsItemsMenu = {.title = "Infinite Items",
                                .nbItems = INF_COUNT,
  ...
  Menu TimeChangeMenu = {.title = "Change Time of Day",
                         .nbItems = 4,
  ...
  Menu DayChangeMenu = {.title = "Change Day",
                        .nbItems = 5,
